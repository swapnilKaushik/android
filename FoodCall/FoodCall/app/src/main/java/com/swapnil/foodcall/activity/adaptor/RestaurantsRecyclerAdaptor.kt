...
class RestaurantsRecyclerAdaptor(val context: Context, val itemList: ArrayList<Restaurants>): RecyclerView.Adapter<RestaurantsRecyclerAdaptor.RestaurantsViewHolder>() {
